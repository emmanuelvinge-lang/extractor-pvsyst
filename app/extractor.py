...
def process_pdf_data(pdf_path):
    ...
    # 3. Producción específica por año P50
    data['Producción específica P50 [kWh/kWp/año]'] = extract_value(full_text, r"Specific production\s*([\d]+)\s*kWh/kWp/year")

    # 4. Generación neta esperada P50
    data['Generación neta esperada P50 [MWh/año]'] = extract_value(full_text, r"Produced Energy\s*([\d\.]+)\s*MWh/year")
